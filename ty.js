...
//     else if(circle.every(q=>circles[q].classList.contains("Rachel"))){
  ...
  const choices = document.querySelectorAll('.cell')
...
function startGame () {
  choices.forEach ( cell => cell.addEventListener("click" , handleClick));
...
cellElements.forEach(cell => cellElements.textContent = "")
start = true
